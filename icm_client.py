...
def paginate(hammock, *args, **kwargs):
    ...
    while True:
        ...
        response = hammock._request('get', *args, **kwargs).json()
...
# Register the LIST function to the pagination generator
setattr(Hammock, 'LIST', paginate)
